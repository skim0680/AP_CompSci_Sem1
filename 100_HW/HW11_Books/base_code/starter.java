...
class starter {
		...
		*/
		while(true){
			...
			if(choice.equals("printNum")){
				System.out.println("How many words would you like printed?");
				int num = sc.nextInt();
				sc.nextLine();
			...
			if(choice.equals("check")){
				...
				System.out.println("There are " + checksArray(arr, string) + " many '" + string + "' in " + textFile);
			}
	...
	*/
	public static int checksArray(String[] arr, String check){
		...
		return num;	// Dummy value, delete when needed.
	}
